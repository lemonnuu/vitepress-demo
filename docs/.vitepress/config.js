...
function nav() {
  return [
    ...
    {
      text: 'VueRouter',
      link: '/VueRouter/000_question',
      activeMatch: '/VueRouter/',
    },
    {
      text: '状态管理器',
      items: [
  ...
  return [
    {
      ...
      items: [
        ...
        { text: '组件', link: '/Vue3/mochi/007_components' },
      ],
    },
    {
      text: '开始',
  ...
  return [
    {
      ...
      collapsible: true,
      items: [
        { text: '问题', link: '/VueRouter/000_question' },
        { text: '前置知识', link: '/VueRouter/001_pre-knowledge' },
        { text: 'Router', link: '/VueRouter/002_router' },
        { text: 'Vue3+TS打造企业级组件库', link: '/VueRouter/test_Vue3TS' },
      ],
    },
  ]
}
